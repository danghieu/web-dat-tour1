                            ...
                            <table>
                                <tbody style="border: 1px">
                                    <tr>
                                        ...
                                        <td><input type="text" name="tourprogramid" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><b>Tên chương trình tour:   </b></td>
                                        <td><input type="text" name="tourprogramname" value="" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="transportation" value="" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="paymentcondition" value="" /></td>
                                    </tr>
