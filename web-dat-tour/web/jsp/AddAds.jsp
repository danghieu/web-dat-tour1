...
<!-- content start -->
		<div id="content">
                    <form action="../CreateAdsServlet" method="POST" >
                    <table>
                        <tr>
                            <td><center><div style="color:red;size:15px" >TẠO QUẢNG CÁO MỚI</div></center></td>
                        </tr>
                        <tr><td>
                            <table>
                                <tbody style="border: 1px">
                                    <tr>
                                        ...
                                        <td><input type="text" name="Link" value="<%=(ads!=null)?ads.getLink():"" %>" style="width: 250px"/></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><b>Link hình ảnh(kích thước tối đa 200x400px):   </b></td>
                                        <td><input type="text" name="Image" value="<%=(ads!=null)?ads.getImage():"" %>"style="width: 250px"/></td>
                                    </tr>
                                    <tr>
