...
<!-- content start -->
		<div id="content">
                    ...
                    <% if(listTourProgram.size()>=0) {for (int i=0;i< listTourProgram.size();i++) { %>
                        <tr>
                            <td>
                                <% out.print(listTourProgram.get(i).getTourProgramId()); %>
                            </td>
                            <td>
                                <% out.print(listTourProgram.get(i).getTourProgramName()); %>
                            </td>
                            <td>
                                <a href="<%="/jsp/tourprogram/Edit.jsp?id="+listTourProgram.get(i).getTourProgramId()%>"> Chỉnh sửa </a> |
                                <a href="<%="/jsp/tourprogram/Delete.jsp?id="+listTourProgram.get(i).getTourProgramId()%>"> Xóa </a> |
                                <a href="<%="/jsp/tourprogram/Detail.jsp?id="+listTourProgram.get(i).getTourProgramId()%>"> Chi tiết </a>
                            </td>
                        </tr>
                    <% } } %>
