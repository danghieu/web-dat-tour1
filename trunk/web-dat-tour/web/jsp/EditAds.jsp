                            ...
                            <table>
                                <tbody style="border: 1px">
                                    ...
                                    <tr><input type="hidden" name="id" value="<% if(ads_bean!=null) out.print(ads_bean.getAdsID()); %>"></input>
                                        ...
                                        <td><input type="text" name="Link" value="<% if(ads!=null) out.print(ads.getLink()); if(ads_bean!=null) out.print(ads_bean.getLink()); %>" style="width: 250px"/></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><b>Link hình ảnh(kích thước tối đa 200x400px):   </b></td>
                                        <td><input type="text" name="Image" value="<% if(ads!=null) out.print(ads.getImage()); if(ads_bean!=null) out.print(ads_bean.getImage()); %>"style="width: 250px"/></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><b>Mô tả:   </b></td>
                                        <td><textarea name="Caption" rows="4" cols="30"><%=(ads!=null)?ads.getImage():"" %></textarea></td>
                                    </tr>                                   
                                </tbody>
                            </table>
                            </td>
