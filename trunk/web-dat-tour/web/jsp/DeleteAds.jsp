...
<!-- content start -->
		<div id="content">
                    <form action="../DeleteAdsServlet" method="POST" >
                    <table>
                        <tr>
                            <td><center><div style="color:red;size:15px" >XÓA QUẢNG CÁO</div></center></td>
                        </tr>
                        <tr><td>
                            <table>
                        ...
                        <tr>
                            <td> <center><input type="submit" value="Xóa" name="Create" /></center></td>
                        </tr>
                    </table>
                </form>
		</div>
